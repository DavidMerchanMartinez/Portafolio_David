...
const Foto = () => {
    return(
        ...
        className="contenedor-principal relative h-[115%] w-2/5  rounded-3xl overflow-hidden -mt-9 bg-white flex justify-center laptop:hidden">
            <img className="absolute inset-0 w-full h-full object-cover object-center" src="https://i.ibb.co/rwtTngC/Whats-App-Image-2024-02-19-at-3-09-08-PM-1.jpg" alt="imagen" />
